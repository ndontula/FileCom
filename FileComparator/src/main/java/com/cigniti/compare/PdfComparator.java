...
import static com.cigniti.compare.Utilities.blockingExecutor;
...
public class PdfComparator<T extends CompareResultImpl> {
     ...
     * {@link com.cigniti.compare.env.SimpleEnvironment} is particularly useful if you want to override some properties.
     *
